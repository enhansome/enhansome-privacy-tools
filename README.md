# Awesome Privacy Tools with stars
...
| Private search            | [DuckDuckGo](https://duckduckgo.com/), [Brave Search](https://search.brave.com/), [Startpage](https://www.startpage.com/), [SearXNG](https://github.com/searxng/searxng) ⭐ 35,471 \| 🐛 217 \| 🌐 Python \| 📅 2026-08-14                                                     |
...
| Self-hosted privacy       | [Nextcloud](https://nextcloud.com/), [Vaultwarden](https://github.com/dani-garcia/vaultwarden) ⭐ 65,408 \| 🐛 86 \| 🌐 Rust \| 📅 2026-08-13, [SearXNG](https://github.com/searxng/searxng) ⭐ 35,471 \| 🐛 217 \| 🌐 Python \| 📅 2026-08-14, [Pi-hole](https://pi-hole.net/) |
...
* [SearXNG](https://github.com/searxng/searxng) ⭐ 35,471 | 🐛 217 | 🌐 Python | 📅 2026-08-14 - Self-hostable metasearch engine.
* [Whoogle](https://github.com/benbusby/whoogle-search) ⭐ 11,598 | 🐛 1 | 🌐 Python | 📅 2026-08-14 - Self-hosted private metasearch proxy.
...
* [uBlock Origin](https://github.com/gorhill/uBlock) ⭐ 66,971 | 🐛 15 | 🌐 JavaScript | 📅 2026-08-14 - Efficient wide-spectrum content blocker.
* [ClearURLs](https://github.com/ClearURLs/Addon) ⭐ 4,998 | 🐛 188 | 🌐 JavaScript | 📅 2025-07-27 - Removes tracking parameters from URLs.
* [Cookie AutoDelete](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete) ⭐ 2,011 | 🐛 172 | 🌐 TypeScript | 📅 2025-12-26 - Deletes cookies from closed tabs with configurable rules.
* [CanvasBlocker](https://github.com/kkapsner/CanvasBlocker/) ⭐ 1,502 | 🐛 64 | 🌐 JavaScript | 📅 2026-02-20 - Helps resist browser fingerprinting techniques.
...
* [dnscrypt-proxy](https://github.com/DNSCrypt/dnscrypt-proxy) ⭐ 13,568 | 🐛 10 | 🌐 Go | 📅 2026-08-13 - Flexible DNS proxy supporting encrypted DNS protocols.
...
* [AdGuard Home](https://github.com/AdguardTeam/AdGuardHome) ⭐ 36,106 | 🐛 1,272 | 🌐 TypeScript | 📅 2026-08-14 - Self-hosted network-wide ad and tracker blocker.
...
* [gocryptfs](https://github.com/rfjakob/gocryptfs) ⭐ 4,561 | 🐛 67 | 🌐 Go | 📅 2026-07-22 - Encrypted overlay filesystem for Linux and macOS.
...
* [qnote](https://github.com/Omibranch/qnote) ⚠️ Archived - Minimal frameless notepad with local-only storage, no telemetry, no cloud. Markdown live preview, real PDF export via Typst, OCR via Tesseract, automatic version history. Available on AUR.
...
* [Secureblue](https://github.com/secureblue/secureblue) ⭐ 1,030 | 🐛 149 | 🌐 Python | 📅 2026-08-14 - Hardened Fedora Atomic images with security-focused defaults.
...
* [Obtainium](https://github.com/ImranR98/Obtainium) ⭐ 18,963 | 🐛 393 | 🌐 Dart | 📅 2026-08-10 - Install and update Android apps directly from release sources.
* [App Manager](https://github.com/MuntashirAkon/AppManager) ⭐ 8,730 | 🐛 214 | 🌐 Java | 📅 2026-06-29 - Android app manager with privacy and permission controls.
* [NetGuard](https://github.com/M66B/NetGuard) ⭐ 3,820 | 🐛 1 | 🌐 Java | 📅 2026-08-01 - No-root firewall for Android.
...
* [ExifEraser](https://github.com/Tommy-Geenexus/exif-eraser) ⭐ 413 | 🐛 11 | 🌐 Kotlin | 📅 2026-08-10 - Android app for removing image metadata.
...
* [Vaultwarden](https://github.com/dani-garcia/vaultwarden) ⭐ 65,408 | 🐛 86 | 🌐 Rust | 📅 2026-08-13 - Lightweight self-hosted Bitwarden-compatible server.
* [Headscale](https://github.com/juanfont/headscale) ⭐ 42,857 | 🐛 142 | 🌐 Go | 📅 2026-07-30 - Open-source coordination server for Tailscale-compatible networks.
* [AdGuard Home](https://github.com/AdguardTeam/AdGuardHome) ⭐ 36,106 | 🐛 1,272 | 🌐 TypeScript | 📅 2026-08-14 - Self-hosted ad and tracker blocking DNS server.
* [SearXNG](https://github.com/searxng/searxng) ⭐ 35,471 | 🐛 217 | 🌐 Python | 📅 2026-08-14 - Self-hosted private metasearch engine.
* [Whoogle](https://github.com/benbusby/whoogle-search) ⭐ 11,598 | 🐛 1 | 🌐 Python | 📅 2026-08-14 - Self-hosted private search proxy.
...
* [ExposureCheck](https://github.com/coraaegis/exposurecheck) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-07-14 - Local-first CLI that audits your own Reddit/X export for AI re-identification (mosaic) risk and shows what to generalise or remove. No dossier, no telemetry, bring your own model.
...
* [TruffleHog](https://github.com/trufflesecurity/trufflehog) ⭐ 27,463 | 🐛 515 | 🌐 Go | 📅 2026-08-14 - Secret scanning tool for repositories and other sources.
* [sops](https://github.com/getsops/sops) ⭐ 22,803 | 🐛 438 | 🌐 Go | 📅 2026-08-10 - Editor for encrypted secrets files.
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,769 | 🐛 100 | 📅 2026-06-30 - The canonical list of awesome lists.
* [Awesome Selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ⭐ 312,677 | 🐛 0 | 📅 2026-08-12 - Self-hosted software and services.
* [Awesome Hacking](https://github.com/Hack-with-Github/Awesome-Hacking) ⭐ 118,330 | 🐛 39 | 📅 2026-07-26 - Security learning resources.
* [Awesome Sysadmin](https://github.com/awesome-foss/awesome-sysadmin) ⭐ 34,900 | 🐛 0 | 📅 2026-06-20 - Open-source sysadmin resources.
* [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,749 | 🐛 304 | 📅 2026-01-11 - Software security resources.
* [Awesome Cryptography](https://github.com/sobolevn/awesome-cryptography) ⭐ 7,066 | 🐛 71 | 📅 2026-07-15 - Cryptography resources and libraries.
