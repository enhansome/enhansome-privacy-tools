...
| Private search            | [DuckDuckGo](https://duckduckgo.com/), [Brave Search](https://search.brave.com/), [Startpage](https://www.startpage.com/), [SearXNG](https://github.com/searxng/searxng) ⭐ 37,639 \| 🐛 195 \| 🌐 Python \| 📅 2026-09-25                                                     |
...
| Self-hosted privacy       | [Nextcloud](https://nextcloud.com/), [Vaultwarden](https://github.com/dani-garcia/vaultwarden) ⭐ 68,161 \| 🐛 87 \| 🌐 Rust \| 📅 2026-09-25, [SearXNG](https://github.com/searxng/searxng) ⭐ 37,639 \| 🐛 195 \| 🌐 Python \| 📅 2026-09-25, [Pi-hole](https://pi-hole.net/) |
...
* [SearXNG](https://github.com/searxng/searxng) ⭐ 37,639 | 🐛 195 | 🌐 Python | 📅 2026-09-25 - Self-hostable metasearch engine.
...
* [uBlock Origin](https://github.com/gorhill/uBlock) ⭐ 68,116 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-25 - Efficient wide-spectrum content blocker.
* [ClearURLs](https://github.com/ClearURLs/Addon) ⭐ 5,050 | 🐛 173 | 🌐 JavaScript | 📅 2025-07-27 - Removes tracking parameters from URLs.
...
* [CanvasBlocker](https://github.com/kkapsner/CanvasBlocker/) ⭐ 1,512 | 🐛 68 | 🌐 JavaScript | 📅 2026-09-07 - Helps resist browser fingerprinting techniques.
...
* [dnscrypt-proxy](https://github.com/DNSCrypt/dnscrypt-proxy) ⭐ 13,689 | 🐛 5 | 🌐 Go | 📅 2026-09-25 - Flexible DNS proxy supporting encrypted DNS protocols.
...
* [AdGuard Home](https://github.com/AdguardTeam/AdGuardHome) ⭐ 37,063 | 🐛 1,257 | 🌐 TypeScript | 📅 2026-09-25 - Self-hosted network-wide ad and tracker blocker.
...
* [gocryptfs](https://github.com/rfjakob/gocryptfs) ⭐ 4,618 | 🐛 65 | 🌐 Go | 📅 2026-09-24 - Encrypted overlay filesystem for Linux and macOS.
...
* [Secureblue](https://github.com/secureblue/secureblue) ⭐ 1,071 | 🐛 163 | 🌐 Python | 📅 2026-09-25 - Hardened Fedora Atomic images with security-focused defaults.
...
* [Obtainium](https://github.com/ImranR98/Obtainium) ⭐ 19,975 | 🐛 385 | 🌐 Dart | 📅 2026-09-13 - Install and update Android apps directly from release sources.
* [App Manager](https://github.com/MuntashirAkon/AppManager) ⭐ 9,064 | 🐛 198 | 🌐 Java | 📅 2026-09-20 - Android app manager with privacy and permission controls.
* [NetGuard](https://github.com/M66B/NetGuard) ⭐ 3,902 | 🐛 1 | 🌐 Java | 📅 2026-08-01 - No-root firewall for Android.
...
* [ExifEraser](https://github.com/Tommy-Geenexus/exif-eraser) ⭐ 426 | 🐛 14 | 🌐 Kotlin | 📅 2026-09-24 - Android app for removing image metadata.
...
* [Vaultwarden](https://github.com/dani-garcia/vaultwarden) ⭐ 68,161 | 🐛 87 | 🌐 Rust | 📅 2026-09-25 - Lightweight self-hosted Bitwarden-compatible server.
* [Headscale](https://github.com/juanfont/headscale) ⭐ 44,135 | 🐛 136 | 🌐 Go | 📅 2026-09-25 - Open-source coordination server for Tailscale-compatible networks.
* [SearXNG](https://github.com/searxng/searxng) ⭐ 37,639 | 🐛 195 | 🌐 Python | 📅 2026-09-25 - Self-hosted private metasearch engine.
* [AdGuard Home](https://github.com/AdguardTeam/AdGuardHome) ⭐ 37,063 | 🐛 1,257 | 🌐 TypeScript | 📅 2026-09-25 - Self-hosted ad and tracker blocking DNS server.
...
* [TruffleHog](https://github.com/trufflesecurity/trufflehog) ⭐ 28,054 | 🐛 554 | 🌐 Go | 📅 2026-09-25 - Secret scanning tool for repositories and other sources.
* [sops](https://github.com/getsops/sops) ⭐ 23,223 | 🐛 448 | 🌐 Go | 📅 2026-09-21 - Editor for encrypted secrets files.
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 510,458 | 🐛 107 | 📅 2026-09-02 - The canonical list of awesome lists.
* [Awesome Selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ⭐ 321,785 | 🐛 0 | 📅 2026-09-25 - Self-hosted software and services.
* [Awesome Hacking](https://github.com/Hack-with-Github/Awesome-Hacking) ⭐ 121,214 | 🐛 43 | 📅 2026-07-26 - Security learning resources.
* [Awesome Sysadmin](https://github.com/awesome-foss/awesome-sysadmin) ⭐ 35,258 | 🐛 0 | 📅 2026-09-17 - Open-source sysadmin resources.
* [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,897 | 🐛 344 | 📅 2026-01-11 - Software security resources.
* [Awesome Cryptography](https://github.com/sobolevn/awesome-cryptography) ⭐ 7,128 | 🐛 75 | 📅 2026-07-15 - Cryptography resources and libraries.
